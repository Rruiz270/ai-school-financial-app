          ...
          <div className="text-center space-y-4">
            ...
            <div className="flex justify-center gap-4">
              <div className="px-4 py-2 bg-blue-100 rounded-lg">
                <span className="text-sm font-medium text-blue-700">Private Sector: </span>
                <span className="text-sm font-bold text-blue-900 capitalize">{currentPrivateScenario}</span>
              </div>
              <div className="px-4 py-2 bg-green-100 rounded-lg">
                <span className="text-sm font-medium text-green-700">Public Sector: </span>
                <span className="text-sm font-bold text-green-900 capitalize">{currentPublicScenario}</span>
              </div>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="border border-gray-200 p-4 rounded-lg">
                    ...
                    <div className="text-xs text-gray-600 space-y-1">
                      ...
                      <p><strong>Teacher Training:</strong> Max(R$800K OR 10% x R$15K)</p>
                    </div>
                  </div>
